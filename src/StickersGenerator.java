...
public class StickersGenerator {
  ...
  // Sobrecarga do metodo create
  public void create(InputStream url, String fileName) throws Exception {
    ...
    try {
      ...
      // insere um texto na parte transparente logo abaixo da imagem usando o textPosY
      // que centraliza a altura do texto
      ...
      System.out.println("não foi possível ler uma imagem de extensão .jpg");
    }
